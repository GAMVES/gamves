...
var tbKeyboardNewFanpage : UIToolbar?
var tfLastNewFanpage : UITextField?
var tvLastNewFanpage : UITextView?


extension NewFanpageController : UITextFieldDelegate, UITextViewDelegate {
    ...
    func createMenu(textObj: AnyObject) {
        ...
        if tbKeyboardNewvideo == nil {
            ...
            if textObj as! NSObject == aboutTextField {
    ...
    func doBtnPrev(_ sender: Any) {
        ...
        } else if (self.current === nameTextField) {
