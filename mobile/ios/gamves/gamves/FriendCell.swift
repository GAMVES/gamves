...
class FriendCell: BaseCell {
    ...
    func setstatusLabel(color:UIColor, symbol:String) {
        
        //self.statusLabel =  Global.createCircularLabel(text: symbol, size: 30, fontSize: 24.0, borderWidth: 3.0, color:color ) //UIColor.gamvesColor)
        self.addSubview(self.statusLabel)
        
        self.addConstraintsWithFormat("H:|-50-[v0(30)]", views: self.statusLabel)
        self.addConstraintsWithFormat("V:|-60-[v0(30)]", views: self.statusLabel)
