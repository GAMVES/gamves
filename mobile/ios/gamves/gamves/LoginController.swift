...
class LoginController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.activityView = Global.setActivityIndicator(container: self.view, type: Int(NVActivityIndicatorType.lineSpinFadeLoader.hashValue), color: UIColor.gambesDarkColor)//,x: 0, y: 0, width: 80.0, height: 80.0)
