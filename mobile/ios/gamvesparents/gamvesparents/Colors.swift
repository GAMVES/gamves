...
extension UIColor {
    ...
    static let gamvesFortniteColor = UIColor.rgb(114, green: 33, blue: 161)
    static let gamvesFortniteDarkColor = UIColor.rgb(57, green: 16, blue: 81)
    ...
    static let gamvesLightLightBlueColor = UIColor.rgb(240, green: 249, blue: 254)
    static let gamvesGamvesLightColor = UIColor.rgb(189, green: 224, blue: 244)
