...
class VideoPlayerView: UIView {
    ...
    {        
        ...
        closeButton.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 30).isActive = true
    ...
    override func layoutSubviews() {
        //self.closeButton.frame = CGRect(x: 0, y: 0, width: self.closeButton.frame.width + 80.0, height: self.closeButton.frame.height + 80.0)        
